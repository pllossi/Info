...
public class GattoTest
{
    ...
    {
        var gatto = new Gatto("Micio", "Europeo", true, "Descrizione", DateTime.Now, new DateTime(2020, 1, 1));
        ...
        Assert.AreEqual(new DateTime(2020, 1, 1), gatto.DataNascita);
    }
    ...
    {
        var gatto = new Gatto("Micio", "Europeo", true, null, DateTime.Now.AddDays(-1));
