...
namespace Boschi_VerificaInfo_11_12_2025
{
    public class Magazzino
    {
        ...
        public Ordine ElaboraOrdine()
        {
            ...
            { 
                throw new InvalidOperationException("Nessun ordine da elaborare.");
            }
            ...
            foreach (var item in ordine.Prodotti)
            {
                ...
                {
                    throw new InvalidOperationException($"Prodotto {p.Nome} non disponibile in quantità sufficiente per ordine {ordine.Id}.");
                }
            }
